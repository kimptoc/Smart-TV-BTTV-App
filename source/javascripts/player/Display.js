...
Display.setTime = function(time)
{
    ...
    bttv.widgetAPI.putInnerHTML(timeElement, timeHTML);
...
{
    bttv.log(status);
    bttv.widgetAPI.putInnerHTML(this.statusDiv, status);
}
...
Display.setVolume = function(level)
{
    ...
    bttv.log("setVol/3");
    bttv.widgetAPI.putInnerHTML(volumeElement, "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + Audio.getVolume());
    bttv.log("setVol/4");
}
...
Display.setVideoList = function(nameList)
{
    ...
    listHTML = "1 / " + i;
    bttv.widgetAPI.putInnerHTML(document.getElementById("videoCount"), listHTML);
}
...
Display.setDescription = function(description)
{
    ...
    bttv.widgetAPI.putInnerHTML(descriptionElement, description);
}
